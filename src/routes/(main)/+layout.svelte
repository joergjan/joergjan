<script lang="ts">
    ...
    onMount(() => {
        function checkScroll() {
            ...
            const myWorkInView =
                myWorkElement &&
                myWorkElement.getBoundingClientRect().top <=
                    window.innerHeight &&
            ...
            const aboutMeInView =
                aboutMeElement &&
                aboutMeElement.getBoundingClientRect().top <=
                    window.innerHeight &&
    ...
    <div class="xl:grid xl:grid-cols-6">
                ...
                <div class="">
                    ...
                    >
                        <div class="flex group">
                            <div
                                class="flex items-center justify-center mr-2 ml-1"
                            >
                                <svg
                            ...
                            <p
                                class="hover:text-teal-500 transition-all duration-250"
                            >
                                CV
                            </p>
                        </div>
        ...
        {#if showMobileMenu}
            <div
                in:slide
                out:slide
                class="fixed z-30 bottom-0 left-0 right-0 bg-gray-800 xl:hidden grid gap-6 items-center justify-center py-6"
            >
                <div>
                    <button
                        class=""
